  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="relative mx-auto max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-[1.75rem] bg-surface pb-[max(1.25rem,env(safe-area-inset-bottom))] shadow-lg motion-safe:animate-in motion-safe:slide-in-from-bottom motion-safe:duration-300"
      >
