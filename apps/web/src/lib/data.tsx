...
export const DEFAULT_TEMPLATES = {
  reminder: 'היי {שם}, כאן {מאמן}. מזכיר לך את האימון מחר ב-{שעה} ב{מיקום}. מאשר/ת? {קישור}',
  debt: 'היי {שם}, כאן {מאמן}. נותר חוב פתוח של {סכום} על {מספר} אימונים. אפשר להסדיר כאן: {קישור}',
}
